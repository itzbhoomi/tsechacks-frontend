      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-4xl rounded-3xl border border-[#E1EAF8] bg-white shadow-xl">
          <div className="flex items-start justify-between border-b border-[#E1EAF8] px-8 py-6">
            ...
            <button onClick={onClose} className="rounded-full border border-[#DCE6F7] px-3 py-1 text-sm">
              ✕
            </button>
          ...
          {/* FUNDING */}
            <div>
              ...
              <div>
                ...
                <div
                  className={`mt-4 rounded-xl border p-4 ${
                    activeStep.reimbursed ? "bg-green-50 border-green-200" : "bg-[#F9FBFF] border-[#E1EAF8]"
                  }`}
                >
                    ...
                    <div className="flex-1 mr-4">
                      <div className="flex items-center gap-2">
                        ...
                        {activeStep.reimbursed && (
                          <span className="text-[10px] bg-green-200 text-green-700 px-2 py-0.5 rounded-full font-bold uppercase">
                            Paid
                          </span>
                        )}
                      </div>
                      ...
                      {isUploading && (
                        <div className="mt-3 flex items-center gap-3">
                          <div className="flex-1 bg-gray-200 rounded-full h-1.5 overflow-hidden">
                            <div
                              className="bg-[#7FAAF5] h-1.5 rounded-full transition-all duration-300"
                              style={{ width: `${uploadProgress}%` }}
                            />
                          </div>
                          <span className="text-[10px] font-bold text-[#7FAAF5] animate-pulse">
                            VERIFYING BILL...
                          </span>
                        </div>
                      )}
                      ...
                      {verificationResult && !isUploading && (
                        ...
                        >
                          <b>{verificationResult.is_appropriate ? "✅ Approved" : "❌ Discrepancy"}</b>:{" "}
              ...
              <div className="flex gap-3 pt-4">
                {userRole === "creator" ? (
                  <button
                    ...
                    className={`rounded-xl px-6 py-3 text-sm font-medium transition ${
                      verificationResult?.is_appropriate && !activeStep.reimbursed && !isUploading
                        ? "bg-[#1E2A3B] text-white shadow-lg"
                  ...
                  <button
                    className="rounded-xl bg-[#7FAAF5] px-6 py-3 text-sm text-white"
            ...
            <div className="space-y-6">
              <div>
                <p className="mb-3 text-sm font-medium">Budget Breakdown</p>
                {budgetData.length > 0 && budgetData.some((item) => item.value > 0) ? (
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        ...
                        <Tooltip
                          ...
                          contentStyle={{ backgroundColor: "#fff", border: "1px solid #E1EAF8" }}
                        />
                        <Legend
                          layout="horizontal"
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center">
          ...
          >
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                type="submit"
                className="rounded-lg bg-green-600 px-5 py-2.5 text-sm text-white font-bold"
              >
                Approve Payment
              </button>
            </div>
